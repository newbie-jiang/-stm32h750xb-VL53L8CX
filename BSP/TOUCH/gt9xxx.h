...
#define GT9XXX_RST_GPIO_CLK_ENABLE()    do{ __HAL_RCC_GPIOD_CLK_ENABLE(); }while(0)   /* PD3口时钟使能 */

#define GT9XXX_INT_GPIO_PORT            GPIOG
#define GT9XXX_INT_GPIO_PIN             GPIO_PIN_12
#define GT9XXX_INT_GPIO_CLK_ENABLE()    do{ __HAL_RCC_GPIOG_CLK_ENABLE(); }while(0)   /* PG12口时钟使能 */
...
#define GT9XXX_CFGS_REG     0X8050      /* GT9XXX配置起始地址寄存器 */	

//#define GT9XXX_CHECK_REG    0X80FF      /* GT9XXX校验和寄存器 */
#define GT9XXX_CHECK_REG    0X813C      /* GT9XXX校验和寄存器 */
